...
private function getGradeAndRemark($score)
{
    ...
    public function generate(Request $request)
    {
            ...
            foreach ($students as $student) {
                ...
                // Initialize an array to store the total scores for each subject
                $totalScores = [];
                ...
                foreach ($subjects as $subject) {
                    ...
                    $subjectScore['exam_score'] = ($examScore) ? $examScore->score : 0;
                ...
                $totalScores[] = $subjectScore['total_score'];
        ...
        // Pass the array of report cards to the view
