...
@section('title')
<title>Dashboard | Contribution Report</title>
@endsection

@section('content')
<main class="main-container">
    <div class="main-title text-secondary">
        <h2>Generate Monthly Social Security Contribution Report</h2>
...
<!--=============== Exiting LEVLS==============-->
    <div class="big-card">
        ...
        <form method="GET" action="{{ route('contribution_report.generate') }}">
