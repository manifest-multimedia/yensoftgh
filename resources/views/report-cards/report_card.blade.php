...
<head>
    ...
    <style type="text/css">
        ...
        .report-card {
            ...
            margin: 0 auto;
            page-break-after: always;
            /* this will create a new page for each report card */
        }
        ...
        <div class="report-card">
            ...
            <div class="grid-container">
                ...
                <div class="grid-item">
                    <strong>
                        <p
                            style="text-align: left;font-size: 18px; text-decoration: upper; text-transform: uppercase;margin-bottom: 0;margin-top: 10px;">
                            {{ $schoolDetails->school_name }}</p>
                    </strong>
                    <p>{{ $schoolDetails->school_address }}, {{ $schoolDetails->school_city }},
                        {{ $schoolDetails->school_region }}, {{ $schoolDetails->school_country }} <br>
            ...
            <h3 style="text-align: center; text-decoration: upper; text-transform: uppercase;">End of Term Examination
            </h3>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">{{ $reportCard['days_present'] }} out of
                                {{ $reportCard['total_days'] }} days</td>
                        </tr>
            ...
            <img class="signature" src="{{ asset('assets/img/signature.png') }}" alt="School Logo"
